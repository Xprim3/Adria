    ...
    <div class="container mx-auto px-4 sm:px-6">
      <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-sm sm:text-base md:text-lg text-primary-dark/80 leading-relaxed max-w-3xl mx-auto tracking-wide font-light px-2">
          {{ description || 'Entdecken Sie unsere authentische italienische Küche mit traditionellen Holzofen-Pizzen, handgemachten Pasten und klassischen italienischen Spezialitäten. Jedes Gericht wird mit den besten Zutaten und bewährten Techniken zubereitet.' }}
        </p>
      </div>
    </div>
  </section>
...
const heading = ref('Speisekarte')
const description = ref('Entdecken Sie unsere authentische italienische Küche mit traditionellen Holzofen-Pizzen, handgemachten Pasten und klassischen italienischen Spezialitäten. Jedes Gericht wird mit den besten Zutaten und bewährten Techniken zubereitet.')

// Load divider content from API
const loadDividerContent = async () => {
  try {
    const response = await fetch(`${API_URL}/content/divider-menu`)
